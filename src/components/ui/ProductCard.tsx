            ...
            <div className="flex flex-col flex-1 p-4 gap-3 bg-white">
                ...
                <div className="flex flex-wrap gap-1">
                    {sizes.map(size => (
                        <span
                            key={size}
                            className="text-[11px] border border-(--primary-color)/20 text-(--secondary-color)/45 px-2 py-0.5 rounded-md"
                        >
                            {size}
                        </span>
                    ))}
                ...
                <div className="flex justify-between items-center mt-auto pt-1 border-t border-(--primary-color)/10">
                    ...
                    <button
                        ...
                        className={`text-xs px-4 py-1.5 rounded-xl font-semibold transition-all duration-200 ${
                            current
                                ? 'bg-(--primary-color) text-white hover:bg-(--primary-color-hover) hover:scale-105 active:scale-95 cursor-pointer'
                                : 'bg-(--secondary-color)/5 text-(--secondary-color)/20 cursor-not-allowed'
                        }`}
                    >
                        Ver
                    </button>
